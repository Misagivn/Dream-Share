    ...
    <div className="max-w-[1600px] item-center">
      ...
      <div className="max-w-[1600px] flex gap-3 grid grid-cols-3">
        <Card
          shadow="sm"
          isPressable
          onPress={() => window.open(`../console/productManager`)}
          className="h-[200px] max-w-[200px]"
        >
          <CardHeader className="absoutule !item-start z-10 top-1">
            <p className="text-small text-lime-300 text-left uppercase font-bold">
              Product Manager Tool
            </p>
          </CardHeader>
          <Image removeWrapper src="product_img.jpg" alt="Default Image" />
        </Card>
        <Card
          shadow="sm"
          isPressable
          onPress={() => window.open(`http://www.google.com`)}
          className="h-[200px] max-w-[200px]"
        >
          <CardHeader className="absoutule !item-start z-10 top-1">
            <p className="text-small text-lime-300 text-left uppercase font-bold">
        ...
        <Card
          shadow="sm"
          isPressable
          onPress={() => window.open(`../console/staffManager`)}
          className="h-[200px] max-w-[200px]"
        >
          <CardHeader className="absoutule !item-start z-10 top-1">
            <p className="text-small text-lime-300 text-left uppercase font-bold">
